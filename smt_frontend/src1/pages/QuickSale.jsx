    ...
    <div className="relative h-[calc(100vh-80px)] overflow-hidden">
      ...
      >
        <div className="sticky top-0 z-10 border-b border-slate-100 bg-white/95 p-4 backdrop-blur-md md:p-6">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:w-85">
        ...
        <div className="flex-1 overflow-y-auto p-4 pb-32 md:p-6 lg:pb-6">
          {isBootLoading ? (
            ...
            <div className="flex min-h-80 flex-col items-center justify-center rounded-4xl border border-dashed border-slate-200 bg-white p-8 text-center">
      ...
      >
        ...
        <div className="flex-1 space-y-4 overflow-y-auto p-4 md:p-6">
          ...
          {cart.length === 0 ? (
            <div className="flex min-h-65 flex-col items-center justify-center rounded-4xl border border-dashed border-slate-200 bg-slate-50 p-8 text-center">
