        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm animate-in fade-in duration-200">
          ...
          <div className="relative flex w-full max-w-4xl flex-col gap-4 lg:flex-row">
            <button
              ...
              className="absolute right-0 -top-13 rounded-full bg-white/20 p-2 text-white hover:bg-white/40"
            >
              <X size={24} />
            </button>
            ...
            <div
              ref={receiptRef}
              className="print-area w-full max-w-sm rounded-4xl bg-white p-8 shadow-2xl animate-in slide-in-from-bottom-4 duration-300 print:mx-auto print:w-[80mm]"
